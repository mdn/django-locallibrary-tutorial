...
#    path('t_memorization_package_mp_technique_assignmenttypes/', views.T_Memorization_Package_MP_Technique_AssignmenttypeListView.as_view(), name='t_memorization_package_mp_technique_assignmenttypes'),
#    path('t_memorization_package_mp_technique_assignmenttype/<int:pk>', views.T_Memorization_Package_MP_Technique_AssignmenttypeDetailView.as_view(), name='t_memorization_package_mp_technique_assignmenttype-detail'),
